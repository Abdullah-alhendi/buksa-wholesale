...
<div class="py-20 bg-gradient-to-bl from-emerald-50 to-blue-50 min-h-screen flex items-center justify-center" dir="rtl">
    <div class="bg-white shadow-lg sm:rounded-lg overflow-hidden hover:shadow-xl transition-all max-w-xl w-full">
        ...
        <div class="p-8 text-center space-y-4">
            ...
            <a href="<?php echo e(route('home')); ?>" class="bg-amber-500 hover:bg-amber-600 text-white font-bold py-2 px-6 rounded-lg shadow-md transition duration-300 inline-flex items-center justify-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alhen\buksa-wholesale\resources\views/errors/404.blade.php ENDPATH**/ ?>