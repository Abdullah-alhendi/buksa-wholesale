...
<div class="container mx-auto px-4 py-12">
    ...
    <?php if(session('success')): ?>
        <div class="mb-4 p-4 bg-green-100 text-green-800 rounded shadow-sm"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="text-center border-b border-gray-100 hover:bg-gray-50 transition-all">
                            ...
                            <td class="p-4 text-gray-700"><?php echo e($item->product->price); ?> د.أ</td>
                            <td class="p-4">
    <form action="<?php echo e(route('cart.update', $item->product->id)); ?>" method="POST" class="flex items-center justify-center gap-2">
        <?php echo csrf_field(); ?>
        ...
        <button type="submit"
            ...
            تحديث
                            ...
                            <td class="p-4 item-total text-emerald-700 font-semibold" data-price="<?php echo e($item->product->price); ?>">
                                <?php echo e($item->product->price * $item->quantity); ?> د.أ
                            </td>
                            <td class="p-4">
        ...
        <div class="mt-6 p-4 bg-gradient-to-r from-emerald-50 to-cyan-50 rounded-lg shadow-sm border border-emerald-100 text-right">
            ...
            <span id="cart-total" class="font-bold text-xl text-emerald-800 mr-2"><?php echo e($total); ?></span>
    ...
    <?php else: ?>
        <div class="bg-gray-50 rounded-lg shadow-sm p-12 text-center">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="mt-4 inline-block bg-cyan-600 text-white px-6 py-2 rounded-md hover:bg-cyan-700 transition-colors">
                استعرض المنتجات
            </a>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alhen\buksa-wholesale\resources\views/cart/index.blade.php ENDPATH**/ ?>