<footer class="bg-gradient-to-r from-amber-600 to-amber-700 text-white py-10 mt-12" dir="rtl">
            ...
            <div class="text-center md:text-right">
                <div class="flex flex-col items-center md:items-start">
                    <a href="/" class="inline-flex items-center mb-4">
                        ...
                        <!-- <img src="<?php echo e(asset('images/logo.png')); ?>" alt="بكسة" class="h-12 w-auto mr-2"> -->
    ...
    <a href="#" class="bg-white text-amber-600 hover:bg-amber-100 p-3 rounded-full transition-all hover:scale-110" aria-label="واتساب">
        <i class="fab fa-whatsapp w-5 h-5 flex items-center justify-center"></i>
            ...
            <div class="text-center md:text-right">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('products.index')); ?>" class="hover:text-white text-gray-200 transition-all flex items-center justify-center md:justify-start">
                            <i class="fas fa-box ml-2"></i>
                            <span>المنتجات</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('categories.index')); ?>" class="hover:text-white text-gray-200 transition-all flex items-center justify-center md:justify-start">
                            <i class="fas fa-tags ml-2"></i>
                            <span>الفئات</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('contact.index')); ?>" class="hover:text-white text-gray-200 transition-all flex items-center justify-center md:justify-start">
            ...
            <div class="text-center md:text-right">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="<?php echo e(route('terms')); ?>" class="hover:text-white text-gray-200 transition-all flex items-center justify-center md:justify-start">
                            <i class="fas fa-file-contract ml-2"></i>
                            <span>الشروط والأحكام</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('returns')); ?>" class="hover:text-white text-gray-200 transition-all flex items-center justify-center md:justify-start">
                            <i class="fas fa-exchange-alt ml-2"></i>
                            <span>سياسة الإرجاع</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('shipping')); ?>" class="hover:text-white text-gray-200 transition-all flex items-center justify-center md:justify-start">
                            <i class="fas fa-truck ml-2"></i>
                            <span>معلومات الشحن</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('faq')); ?>" class="hover:text-white text-gray-200 transition-all flex items-center justify-center md:justify-start">
        ...
        <div class="border-t border-amber-500 mt-12 pt-6 text-center text-white flex flex-col md:flex-row justify-between items-center gap-4">
            <p>© <?php echo e(date('Y')); ?> بكسة. جميع الحقوق محفوظة</p>
...
<?php /**PATH C:\Users\alhen\buksa-wholesale\resources\views/partials/footer.blade.php ENDPATH**/ ?>