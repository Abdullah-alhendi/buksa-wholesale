    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-bold text-xl text-emerald-800 leading-tight">
                <span class="border-b-2 border-amber-400 pb-1">{{ __('إدارة الفئات') }}</span>
            </h2>
            ...
            <div class="p-0 bg-white shadow-lg sm:rounded-lg overflow-hidden transform transition-all hover:shadow-xl">
                <div class="bg-gradient-to-l from-emerald-800 to-emerald-700 text-white py-4 px-6 border-r-4 border-amber-400">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('categories.create') }}" class="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded-lg transition duration-300 flex items-center text-sm">
                    ...
                    <table class="w-full min-w-max">
                        <thead>
                            <tr class="border-b border-gray-200">
                                ...
                                <th class="py-3 px-4 text-right text-emerald-800 font-semibold">عدد المنتجات</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150">
                                <td class="py-4 px-4 font-medium text-gray-700">{{ $category->name }}</td>
                                <td class="py-4 px-4 text-gray-500">{{ $category->products_count ?? 0 }}</td>
                                <td class="py-4 px-4">
