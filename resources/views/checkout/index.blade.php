...
<div class="py-12 bg-gradient-to-bl from-emerald-100 to-blue-100 min-h-screen" dir="rtl">
                        ...
                        <tbody>
                            @foreach ($cart->items as $item)
                                <tr class="text-gray-700 border-t border-gray-100 hover:bg-gray-50 transition-colors">
                                    <td class="py-4 px-3 md:px-6 font-medium">{{ $item->product->name }}</td>
                                    <td class="py-4 px-3 md:px-6 text-center">{{ number_format($item->product->price, 2) }} د.أ</td>
                                    <td class="py-4 px-3 md:px-6 text-center">
                                        <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">
                                            {{ $item->quantity }}
                                        </span>
                                    </td>
                                    <td class="py-4 px-3 md:px-6 text-center font-bold text-emerald-700">{{ number_format($item->product->price * $item->quantity, 2) }} د.أ</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr class="bg-gray-50">
                                ...
                                <td class="py-4 px-6 text-center font-bold text-lg text-emerald-700">{{ number_format($total, 2) }} د.أ</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
    ...
    تأكيد الطلب وإتمام الدفع
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('cart.index') }}" class="text-blue-600 hover:text-blue-800 inline-flex items-center">
